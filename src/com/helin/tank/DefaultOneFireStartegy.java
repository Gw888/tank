 ...
 */
public class DefaultOneFireStartegy implements FireStartegy {
    ...
    public void fire(BaseGun baseGun) {
        ...
        Bullet bullet = new Bullet(baseGun.getX(), baseGun.getY(), baseGun.getDir(), baseGun.getGroup(), baseGun.getTf());
    }
